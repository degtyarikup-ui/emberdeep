...
export const SPRITE_DEFS: Record<string, SpriteDefinition> = {
  ...
  cabin: { url: asset('prop_cabin.png'), widthTiles: 2.0, heightTiles: 1.5 },
  station_anvil: { url: asset('structures/prop_station_anvil.png'), widthTiles: 2.0, heightTiles: 1.5 },
  station_furnace: { url: asset('structures/prop_station_furnace.png'), widthTiles: 1.0, heightTiles: 1.5 },
  station_alchemy: { url: asset('structures/prop_station_alchemy.png'), widthTiles: 1.5, heightTiles: 2.0 },
  station_spit_fire: { url: asset('structures/prop_station_spit_fire.png'), widthTiles: 1.5, heightTiles: 1.5 },
  station_butcher: { url: asset('structures/prop_station_butcher.png'), widthTiles: 1.5, heightTiles: 1.5 },
  station_stone_arch: { url: asset('structures/prop_station_stone_arch.png'), widthTiles: 1.5, heightTiles: 1.5 },
  station_sarcophagus: { url: asset('structures/prop_station_sarcophagus.png'), widthTiles: 1.0, heightTiles: 1.5 },
  station_coffin: { url: asset('structures/prop_station_coffin.png'), widthTiles: 1.0, heightTiles: 1.5 },
  station_log_pile: { url: asset('structures/prop_station_log_pile.png'), widthTiles: 1.0, heightTiles: 1.0 },
  ...
  [TEXTURE.PROP_CABIN]: { url: asset('prop_cabin.png'), widthTiles: 2.0, heightTiles: 1.5 },
  [TEXTURE.PROP_STATION_ANVIL]: { url: asset('structures/prop_station_anvil.png'), widthTiles: 2.0, heightTiles: 1.5 },
  [TEXTURE.PROP_STATION_FURNACE]: { url: asset('structures/prop_station_furnace.png'), widthTiles: 1.0, heightTiles: 1.5 },
  [TEXTURE.PROP_STATION_ALCHEMY]: { url: asset('structures/prop_station_alchemy.png'), widthTiles: 1.5, heightTiles: 2.0 },
  [TEXTURE.PROP_STATION_SPIT_FIRE]: { url: asset('structures/prop_station_spit_fire.png'), widthTiles: 1.5, heightTiles: 1.5 },
  [TEXTURE.PROP_STATION_BUTCHER]: { url: asset('structures/prop_station_butcher.png'), widthTiles: 1.5, heightTiles: 1.5 },
  [TEXTURE.PROP_STATION_STONE_ARCH]: { url: asset('structures/prop_station_stone_arch.png'), widthTiles: 1.5, heightTiles: 1.5 },
  [TEXTURE.PROP_STATION_SARCOPHAGUS]: { url: asset('structures/prop_station_sarcophagus.png'), widthTiles: 1.0, heightTiles: 1.5 },
  [TEXTURE.PROP_STATION_COFFIN]: { url: asset('structures/prop_station_coffin.png'), widthTiles: 1.0, heightTiles: 1.5 },
  [TEXTURE.PROP_STATION_LOG_PILE]: { url: asset('structures/prop_station_log_pile.png'), widthTiles: 1.0, heightTiles: 1.0 },

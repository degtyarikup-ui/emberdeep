...
const WOLF: ActorClips = {
  ...
  run: { key: 'anim-wolf-run', url: asset('pc-wolf-run.png'), frameWidth: 32, frameHeight: 32, frameCount: 4, frameRate: 7, repeat: -1 },
...
const DIREWOLF: ActorClips = {
  ...
  run: { key: 'anim-direwolf-run', url: asset('direwolf-run.png'), frameWidth: 32, frameHeight: 32, frameCount: 4, frameRate: 7, repeat: -1 },
  death: { key: 'anim-wolf-death', url: asset('pc-wolf-death.png'), frameWidth: 32, frameHeight: 32, frameCount: 6, frameRate: 9, repeat: 0 },
};

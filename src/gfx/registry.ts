export const TEXTURE = {
  ...
  PROP_STATION_ANVIL: 'tex-prop-station-anvil',
  PROP_STATION_FURNACE: 'tex-prop-station-furnace',
  PROP_STATION_ALCHEMY: 'tex-prop-station-alchemy',
  PROP_STATION_SPIT_FIRE: 'tex-prop-station-spit-fire',
  PROP_STATION_BUTCHER: 'tex-prop-station-butcher',
  PROP_STATION_STONE_ARCH: 'tex-prop-station-stone-arch',
  PROP_STATION_SARCOPHAGUS: 'tex-prop-station-sarcophagus',
  PROP_STATION_COFFIN: 'tex-prop-station-coffin',
  PROP_STATION_LOG_PILE: 'tex-prop-station-log-pile',

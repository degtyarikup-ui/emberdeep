...
const RU: TranslationDict = {
  ...
  knightTitle: 'РЫЦАРЬ',
  knightStats: 'Меч (Блок щитом)',
  rangerTitle: 'СЛЕДОПЫТ',
  rangerStats: 'Лук (Дальний бой)',
  wizardTitle: 'ВОЛШЕБНИК',
  wizardStats: 'Посох (Магия эфира)',
  langBtn: 'ЯЗЫК: RU',
...
const EN: TranslationDict = {
  ...
  knightTitle: 'KNIGHT',
  knightStats: 'Sword (Shield Block)',
  rangerTitle: 'RANGER',
  rangerStats: 'Bow (Ranged Combat)',
  wizardTitle: 'WIZARD',
  wizardStats: 'Staff (Ether Magic)',
  langBtn: 'LANG: EN',

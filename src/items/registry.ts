...
export const ITEMS: Record<string, ItemDef> = {
  ...
  lucky_horseshoe: {
    ...
    tier: 'common',
    icon: PROP.ITEM_LUCKY_HORSESHOE,
    color: '#34d399',
  },
  berserker_wristband: {
    ...
    tier: 'common',
    icon: PROP.ITEM_BERSERKER_WRISTBAND,
    color: '#fb923c',
  },
  ...
  thunder_talisman: {
    ...
    tier: 'uncommon',
    icon: PROP.ITEM_THUNDER_TALISMAN,
    color: '#fef08a',
  },
  ...
  toxic_mist_dash: {
    ...
    tier: 'uncommon',
    icon: PROP.ITEM_TOXIC_MIST_DASH,
    color: '#84cc16',
    element: 'poison',
    elementSlot: 'dash',
  },
  ...
  chrono_hourglass: {
    ...
    tier: 'uncommon',
    icon: PROP.ITEM_CHRONO_HOURGLASS,
    color: '#c084fc',
  },
  executioner_axe: {
    id: 'executioner_axe',
    ...
    tier: 'uncommon',
    icon: PROP.ITEM_EXECUTIONER_AXE,
    color: '#e11d48',
  },
  ...
  giant_slayer_ring: {
    ...
    tier: 'legendary',
    icon: PROP.ITEM_GIANT_SLAYER_RING,
    color: '#a855f7',
  },
  prismatic_prism: {
    id: 'prismatic_prism',
    ...
    tier: 'legendary',
    icon: PROP.ITEM_PRISMATIC_PRISM,
    color: '#f0abfc',
  },
};

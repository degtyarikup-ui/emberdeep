...
export function buildLevel1(depth = 1): LevelData {
  ...
  return {
    ...
    decorations: [
      ...
      { col: 9, row: 4, key: PROP.TOMBSTONE, solid: false },
      ...
      { col: 26, row: 3, key: PROP.TOMBSTONE, solid: false },
      { col: 22, row: 0, key: PROP.BANNER_BLUE, solid: false },
      { col: 16, row: 14, key: PROP.TOMBSTONE, solid: false },
      { col: 27, row: 20, key: PROP.TOMBSTONE, solid: false },
      ...
      { col: 38, row: 15, key: PROP.TOMBSTONE, solid: false },
    ],
    flasks: [
